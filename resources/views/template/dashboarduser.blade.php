...
<html lang="en">
  <head>
    ...
    <title>Toko Obat Munggaran | Beranda</title>
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="aa-currency">
                  <p><span class="fa fa-envelope"></span>Email : Obatmunggaran@gmail.com</p>
                </div>
                <!-- / currency -->
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li class="hidden-xs"><a href="cart.html">Keranjang Saya</a></li>
      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="{{url('/assets/img/slider/covid.jpg')}}" alt="Men slide img" />
              </div>
              <!-- <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="{{url('/assets/img/slider/cc.jpg')}}" alt="Women Jeans slide img" />
              </div>
              <!-- <div class="seq-title">
                <span data-seq>Save Up to 75% Off</span>                
